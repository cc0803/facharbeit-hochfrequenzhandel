...
if (width >= 800) {
	const video =
		'<h1>Inwieweit stellen der Hochfrequenzhandel und Hedgefonds ein Risiko für Privatanleger dar?</h1><video src="./assets/startingPage.mp4" autoplay muted loop id="background-video" poster="./assets/startingPagePicture.png"></video>';
